...
import 'package:plantss2/splash_screen/splash_screen_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<Plantss2FirebaseUser> userStream;
  Plantss2FirebaseUser initialUser;
  final authUserSub = authenticatedUserStream.listen((_) {});

  @override
  void initState() {
    super.initState();
    userStream = plantss2FirebaseUserStream()
